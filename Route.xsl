    ...
    <header id="header">
        ...
        <nav class="navbar navbar-inverse" role="banner">
			...
			<li><a href="trainreservation/contact.html">Contact us</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> Status <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="status.xml">Train Status</a></li>
                                <li class="active"><a href="Route.xml">Train Route</a></li>
...
<section style="background-color: black;">
		<h1 style="text-align:center">Train route Details</h1>
		...
		<xsl:for-each select="Trainticket/trainroute">
		
		<tr>
		<td>
		<xsl:value-of select="stopno"></xsl:value-of>
		</td>
		<td>
		...
		<td>
		<xsl:value-of select="distance"></xsl:value-of>
		</td>
		</tr>
		</xsl:for-each>
		</table>
